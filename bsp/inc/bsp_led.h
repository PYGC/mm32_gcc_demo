...
/// @{
...
#if defined(__MM32_MB022) || defined(__MM32_MB023) || defined(__MM32_MB024) || defined(__MM32_MB025) || defined(__MM32_MB036) || defined(__MM32_MB039) || defined(__MM32_MB041)
    ...
    #define LED2_CONFIG {COMMON_EnableIpClock(emCLOCK_GPIOB);GPIO_SetBits(LED2_PORT, LED2_BIT); GPIO_Mode_OUT_OD_20MHz_Init(LED2_PORT, LED2_BIT, 0x02U << 24, GPIO_AF_0);}
